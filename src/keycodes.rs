...
/// https://raw.githubusercontent.com/Narsil/rdev/5b8d4127e6c9c08553d0188bf812343ae06b19a1/src/linux/keycodes.rs
///
/// For some reason, rdev does not expose the keycode function, so I just copy-pasted it over.
///
use rdev::Key;
